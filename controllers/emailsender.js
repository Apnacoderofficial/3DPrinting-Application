...
const sendMail = (to, cc, bcc, subject, htmlContent) => {
    // Set up mail options
    const mailOptions = {
        from: '"3D Printing" <apnaofficialcoder@gmail.com>',
        to: to,
        cc: cc,
        bcc: bcc,
        subject: subject + " - 3D Printing",
        html : `
        <html>
        <head>
        ...
        <body>
            <div class="container">
                <header>
                    <img src="https://www.apnacoder.com/assets/img/logo/ApnaCodertrans.png" alt="Store Logo" > <!-- Replace 'logo.png' with the path to your logo image -->
                </header>
                ...
                <div class="support">
                    <p>Contact us at <a href="mailto:info@apnacoder.com">info@apnacoder.com</a></p>
                </div>
                <footer>
